...
#region Variable
	...
	[NonSerialized] protected readonly List<PoolObject<T>> _poolList = new();

	[NonSerialized] protected readonly Queue<PoolObject<T>> _queu = new();
...
#if UNITY_EDITOR
	[NonSerialized] protected static Transform _allPoolsParent;
	[NonSerialized] protected static Transform _allPoolsParentDDOL;
#endif
...
#region PoolObject
	...
	protected bool _TryDequeue(out PoolObject<T> poolObject, Vector3 position = new(), Quaternion rotation = new(),
...
#region Dequeue T
	...
	public T Dequeue(Vector3 position = new(), Quaternion rotation = new(), Transform parent = null, bool active = true)
	{
		TryDequeue(out var component, position, rotation, parent, active);
		return component;
	}

	public bool TryDequeue(out T component, Vector3 position = new(), Quaternion rotation = new(),
		Transform parent = null, bool active = true)
	{
...
#region Dequeue GameObject
	...
	public GameObject DequeueGameObject(Vector3 position = new(), Quaternion rotation = new(), Transform parent = null,
		bool active = true)
	{
	...
	public bool TryDequeueGameObject(out GameObject gameObject, Vector3 position = new(), Quaternion rotation = new(),
		Transform parent = null, bool active = true)
	{
		if (_TryDequeue(out var poolObject, position, rotation, parent, active))
		{
		...
		if (returnValue == ReturnValue.EmptyGameObject)
		{
#if UNITY_EDITOR
			gameObject = new($"{_Prefab.name}_Fake");
#else
...
#region Dequeue Transform
	...
	public Transform DequeueTransform(Vector3 position = new(), Quaternion rotation = new(), Transform parent = null,
		bool active = true)
	{
	...
	public bool TryDequeueTransform(out Transform transform, Vector3 position = new(), Quaternion rotation = new(),
		Transform parent = null, bool active = true)
	{
		if (_TryDequeue(out var poolObject, position, rotation, parent, active))
		{
...
#region Dequeue Component
	...
	public C DequeueComponent<C>(Vector3 position = new(), Quaternion rotation = new(), Transform parent = null,
		bool active = true) where C : Component
	{
		TryDequeueComponent(out C component, position, rotation, parent, active);
		return component;
	}

	public bool TryDequeueComponent<C>(out C component, Vector3 position = new(), Quaternion rotation = new(),
		Transform parent = null, bool active = true) where C : Component
	{
